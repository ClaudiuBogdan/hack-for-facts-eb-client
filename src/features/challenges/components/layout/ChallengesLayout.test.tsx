...
const mockLocation = {
  pathname: '/bugete-locale-2026/87654321/provocari/test-module/test-challenge/test-step',
  search: {},
}
...
describe('ChallengesLayout', () => {
  beforeEach(() => {
    mockLocation.pathname =
      '/bugete-locale-2026/87654321/provocari/test-module/test-challenge/test-step'
    mockLocation.search = {}
