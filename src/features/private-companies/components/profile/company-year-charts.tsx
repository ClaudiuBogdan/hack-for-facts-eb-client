...
/**
 * The company profile's annual charts, in the INS charts' idiom — ticks in the
 * gutter, HTML text over a stretched SVG, a rule and a tooltip on the year
 * being read, the same pointer and keyboard model — for figures that are one
 * number per year rather than a trend: a statement per fiscal year, money per
 * year.
 *
