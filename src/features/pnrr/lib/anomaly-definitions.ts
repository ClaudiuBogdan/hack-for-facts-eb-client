...
export const ANOMALY_CONFIG: readonly AnomalyConfig[] = [
  ...
  },
  {
    ...
    shortDescription: t`Exploration preset: over 10 mil. RON and progress under 30%`,
    explanation: t`This exploratory preset highlights projects with large listed EU funding and low reported technical progress. It is not a finding and requires verification in official documents.`,
    investigationTip: t`Check delayed procurements, authorizations, disputes, beneficiary capacity, and execution blockages.`,
    detectionRule: t`Exploration preset: listed EU funding >= 10,000,000 RON and reported technical progress under 30%, including the published "under 30%" category`,
    icon: AlertTriangle,
    severity: 'critical',
  },
  {
...
export const DATA_QUALITY_SIGNAL_CONFIG: readonly DataQualitySignalConfig[] = [
  ...
  },
  {
    ...
    shortDescription: t`Exploration preset: over 10 mil. RON without usable financial data`,
    ...
    detectionRule: t`Exploration preset: listed EU funding >= 10,000,000 RON and financial progress not published in dataset`,
    icon: FileQuestion,
    severity: 'attention',
  },
  {
    ...
    shortDescription: t`Exploration preset: 100% technical, over 1 mil. RON, without financial data`,
    ...
    detectionRule: t`Exploration preset: reported technical progress = 100%, listed EU funding >= 1,000,000 RON and financial progress not published in dataset`,
    icon: FileWarning,
    severity: 'attention',
  },
] as const
