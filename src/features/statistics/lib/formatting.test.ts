...
import { sharedDecimals, sourceDecimals } from './numbers'
import { hubUnitOf, formatHubValue, hubUnitWord } from './units'
import { sameMonthLastYear } from './period'
import { describeAgainstNational, describeHubDelta, formatHubChange, hubChange, formatHubSigned } from './change'
import { alignSeriesByPeriod, annualInflationRate, deathsExceedBirthsSince } from './hub-indicators'
