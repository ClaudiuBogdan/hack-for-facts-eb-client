...
import { LIT_CLASS, TRAIL_BASE_PX } from '@/features/landing/components/light-material'
import { FOCUS_RATIO, SECTION_LIGHT_ATTR, sectionClaimAt } from '@/features/landing/components/section-light'
