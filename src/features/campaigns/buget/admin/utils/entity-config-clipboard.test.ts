...
describe("entity-config-clipboard", () => {
  ...
  it("unwraps Markdown links generated by chat tools", () => {
    const parsed = parseCampaignAdminEntityConfigClipboard(
      "Entity CUI\tBudget Publication Date\tOfficial Budget URL\tUpdated At\n"
        + "12345678\t2026-04-20\t[https://oras.test/final.pdf](https://oras.test/final.pdf)\t2026-04-18T09:00:00.000Z\n",
    );
  ...
  it("recovers public debate values when empty TSV cells collapse after users count", () => {
    const parsed = parseCampaignAdminEntityConfigClipboard(
      "entityCui\tentityName\tusersCount\tbudgetPublicationDate\tofficialBudgetUrl\tpublic_debate.date\tpublic_debate.time\tpublic_debate.location\tpublic_debate.online_participation_link\tpublic_debate.announcement_link\tpublic_debate.description\tupdatedAt\n"
        + "4121927\tMUNICIPIUL CURTEA DE ARGES\t1 2026-04-30 10:00 Sala de sedinte a Primariei Municipiului Curtea de Arges https://www.primariacurteadearges.ro/anunt.pdf Dezbatere publica privind proiectul de buget local\n",
    );
    ...
    expect(parsed.rows).toEqual([
      {
        rowNumber: 2,
        entityCui: "4121927",
        entityName: "MUNICIPIUL CURTEA DE ARGES",
        values: {
          ...
          public_debate: {
            date: "2026-04-30",
            time: "10:00",
            location: "Sala de sedinte a Primariei Municipiului Curtea de Arges",
            announcement_link: "https://www.primariacurteadearges.ro/anunt.pdf",
          },
        },
