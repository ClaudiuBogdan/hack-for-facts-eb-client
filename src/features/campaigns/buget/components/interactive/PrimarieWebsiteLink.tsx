...
export function PrimarieWebsiteLink({ challengeSlug }: CampaignInteractiveElementProps) {
  ...
  if (form.isSubmitted && form.savedValue) {
    return (
      <div className="relative overflow-hidden rounded-[28px] border border-amber-200/60 bg-gradient-to-br from-amber-50/40 via-background to-amber-50/20 p-6 shadow-sm dark:border-amber-800/40 dark:from-amber-950/20 dark:via-background dark:to-amber-950/10 md:p-8">
        {/* Decorative watermark */}
        <Globe className="pointer-events-none absolute -top-2 right-4 h-20 w-20 rotate-6 text-amber-500/[0.06]" />
