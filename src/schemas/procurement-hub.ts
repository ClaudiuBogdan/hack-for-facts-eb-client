...
export const PROCUREMENT_HUB_CAPABILITIES: readonly HubCapability[] = [
  ...
  },
  {
    ...
    overview: 'na',
    list: 'live',
    note: 'Counts of the CURRENT result set per filter option — search-engine aggregations, so a database-served record type has none; never authoritative analytics',
    keys: [],
  ...
  },
  {
    ...
    overview: 'na',
    list: 'live',
    note: 'Engine pages carry the index build stamp ("as of"); database pages are read live and say so',
    keys: [],
  },
  {
    id: 'rankings',
