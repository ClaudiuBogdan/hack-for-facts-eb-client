...
export const POPULATION_METHODOLOGY = msg`Population methodology: Bucharest sector figures for 2020 are provisional INS data (January 1 domicile population). Bucharest city uses a separate series. Missing years use the latest verified earlier population of the same territory and measure, with its original source year retained. Years without an earlier observation remain unavailable.`;
