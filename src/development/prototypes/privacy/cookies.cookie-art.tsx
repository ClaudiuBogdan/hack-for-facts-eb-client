...
// Integer geometry, a fixed palette and ordered dithering keep it pixel art
// at both 64px and 256px. No blur, smooth gradients, or random noise filters.
...
export function CookieIllustrationStudy() {
  ...
  return (
    <section className="bg-background px-6 py-12 text-foreground sm:px-12 sm:py-16">
