...
/**
 * The page's numbers in its language, as the `/companies` hub writes them:
 * money on one scale per magnitude and never past billions, a percent with
 * one decimal against the figure, counts whole.
 */
