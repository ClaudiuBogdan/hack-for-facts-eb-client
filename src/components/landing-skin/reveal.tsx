...
/**
 * Rendered as a style element by whichever page arms the hook, on the server
 * too, so the first paint already has it. Kept beside the hook rather than in
 * `src/index.css` because the attribute state machine and the CSS that reads
 * it are one contract — see `docs/design/landing/design.md`.
 */
