    ...
    <div className="mx-auto w-full max-w-4xl p-6 space-y-6">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li><strong>Vârsta minimă:</strong> Serviciul este destinat exclusiv persoanelor majore, în vârstă de cel puțin 18 ani. Prin crearea unui cont sau utilizarea Serviciului, declarați că aveți cel puțin 18 ani.</li>
        ...
        <ul>
          ...
          <li><strong>Postare anonimă sau pseudonimă:</strong> Forumul poate oferi mod anonim sau alte funcționalități de postare pseudonimă. Când acestea sunt active, postările pot apărea sub o identitate anonimă sau alternativă pentru ceilalți utilizatori. Totuși, sistemul forumului și operatorii platformei, moderatorii sau administratorii pot păstra ori accesa în continuare legăturile tehnice și de cont necesare pentru securitate, moderare, prevenirea abuzurilor sau conformare legală.</li>
          <li><strong>Vizibilitate publică:</strong> Multe postări de pe forum sunt accesibile public fără cont. Prin postarea pe forum, recunoașteți că contribuțiile dumneavoastră pot fi vizibile oricui pe internet. Postarea anonimă sau pseudonimă poate reduce atribuirea publică, dar nu face conținutul invizibil pentru sistemul forumului sau pentru operatorii platformei responsabili de moderare și conformitate.</li>
          <li><strong>Conținut ilegal:</strong> Nu trebuie să publicați conținut ilegal conform legii aplicabile, inclusiv amenințări ilegale, hărțuire, discurs instigator la ură, divulgare ilegală a datelor personale ale terților, încălcări ale drepturilor de autor, fraudă, malware, uzurpare ilegală de identitate sau alt conținut interzis de lege.</li>
        ...
        <ul>
          ...
          <li><strong>Suport pentru moderare și evaluarea riscurilor:</strong> Acolo unde sunt activate, instrumentele AI pot ajuta și la clasificarea conținutului, suport pentru moderare, detectarea abuzurilor, prioritizare sau control al calității. Astfel de instrumente sunt doar de asistență și nu înlocuiesc evaluarea juridică ori factuală atunci când este necesară o revizuire umană.</li>
        ...
        <ul>
          ...
          <li><strong>Date forum:</strong> Forumul stochează postările, informațiile de profil, istoricul de citire și jurnalele de activitate atât timp cât este necesar pentru operarea forumului și aplicarea acestor Termeni. Ștergerea contului poate să nu elimine automat tot conținutul de forum public sau publicat anterior.</li>
          ...
          <li><strong>Ștergere:</strong> Puteți solicita ștergerea sau anonimizarea datelor de cont aflate sub controlul nostru oricând contactându-ne sau utilizând funcțiile de ștergere a contului, când sunt disponibile, sub rezerva Politicii de confidențialitate, excepțiilor legale, copiilor de siguranță, limitărilor tehnice, integrității forumului public și înregistrărilor deja livrate instituțiilor publice sau altor operatori independenți.</li>
        </ul>
