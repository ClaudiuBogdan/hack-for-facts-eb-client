    ...
    <div className="mx-auto w-full max-w-4xl p-6 space-y-6">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li><strong>Minimum Age:</strong> The Service is intended only for adults aged 18 or older. By creating an account or using the Service, you represent that you are at least 18 years old.</li>
        ...
        <ul>
          ...
          <li><strong>Anonymous or Pseudonymous Posting:</strong> The forum may offer anonymous mode or similar pseudonymous posting features. When active, your posts may appear under an anonymous or alternate display identity to other users. However, the forum system and platform operators, moderators, or administrators may still retain or access technical and account linkage necessary for security, moderation, abuse prevention, or legal compliance.</li>
          <li><strong>Public Visibility:</strong> Many forum posts are publicly readable without an account. By posting on the forum, you acknowledge that your contributions may be visible to anyone on the internet. Anonymous or pseudonymous posting may reduce public attribution, but it does not make content invisible to the forum system or to platform operators responsible for moderation and compliance.</li>
          <li><strong>Illegal Content:</strong> You must not post content that is illegal under applicable law, including unlawful threats, harassment, hate speech, unlawful disclosure of third-party personal data, copyright infringement, fraud, malware, unlawful impersonation, or other unlawful content.</li>
        ...
        <ul>
          <li><strong>AI-Enhanced and Experimental Features:</strong> The Service may offer AI-enhanced or experimental features to help users analyze public data, process or summarize documents, extract structured information, classify or compare records, generate drafts, answer questions, detect patterns, or support research workflows. Some of these features may be optional, limited, beta, or withdrawn at any time.</li>
          ...
          <li><strong>Moderation and Risk Support:</strong> Where enabled, AI tools may also assist content classification, moderation support, abuse detection, prioritization, or quality review. Such tools are assistive only and do not replace legal or factual judgment where human review is required.</li>
        ...
        <ul>
          ...
          <li><strong>Public Sharing:</strong> If you choose to post, publish, or share content publicly through the Service, including forum contributions or publicly shared maps and similar public outputs, that content may become accessible to the public, may be indexed by search engines, and may be copied or reshared by others.</li>
        ...
        <ul>
          ...
          <li><strong>Forum Data:</strong> The forum stores your posts, profile information, reading history, and activity logs for as long as needed to operate the forum and enforce these Terms. Deleting your account may not automatically remove all publicly visible or previously published forum content.</li>
          ...
          <li><strong>Deletion:</strong> You may request deletion or anonymization of account data we control at any time by contacting us or using account deletion features when available, subject to the Privacy Policy, legal exceptions, backups, technical limitations, public-forum integrity, and records already delivered to public institutions or other independent controllers.</li>
        </ul>
