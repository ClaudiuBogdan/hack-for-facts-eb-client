    ...
    <div className="mx-auto w-full max-w-4xl p-6 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <ul className="list-disc pl-6 text-sm text-muted-foreground space-y-1">
          ...
          <li>Forum comunitar integrat cu contul dumneavoastră; datele forumului sunt gestionate prin Discourse și infrastructura de găzduire aferentă.</li>
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li><strong>Activitate forum:</strong> Postări, răspunsuri, aprecieri, marcaje, istoric de citire, preferințe de urmărire a subiectelor, metrici de participare și discuții legate de funcționalitățile platformei, lecții, campanii sau activități derulate împreună cu parteneri. Aceste date sunt stocate de sistemul forumului Discourse, iar unele contribuții pot fi vizibile public fără cont.</li>
          <li><strong>Utilizare anonimă sau pseudonimă a forumului:</strong> Dacă utilizați modul anonim sau o funcționalitate similară de postare pseudonimă, forumul poate afișa contribuțiile sub o identitate publică alternativă, însă sistemul forumului și operatorii platformei pot păstra în continuare legături tehnice sau de cont necesare pentru moderare, prevenirea abuzurilor, securitate și conformare legală.</li>
          <li><strong>Date de moderare forum:</strong> Adrese IP complete, user agent și marca temporală asociate acțiunilor pe forum, păstrate pentru moderarea conținutului, prevenirea abuzurilor și conformare legală (interese legitime conform RGPD Art. 6(1)(f)).</li>
        ...
        <ul>
          ...
          <li><strong>Inputuri AI:</strong> Date publice, documente publice, prompturi, întrebări, fișiere încărcate sau transmise, text extras și alte inputuri pe care alegeți să le furnizați unei funcții îmbunătățite cu AI, dacă funcționalitatea relevantă acceptă un astfel de conținut.</li>
          <li><strong>Outputuri și derivate AI:</strong> Constatări, rezumate, clasificări, date structurate extrase, texte în draft, răspunsuri, adnotări sau alte rezultate generate ori asistate de sisteme AI ca răspuns la inputul relevant.</li>
        ...
        <ul>
          ...
          <li><strong>Funcții îmbunătățite cu AI:</strong> Pentru a opera funcțiile îmbunătățite cu AI sau experimentale pe care alegeți să le utilizați, inclusiv analiza datelor publice, procesarea documentelor, extragerea, rezumarea, clasificarea, generarea de drafturi, asistența pentru cercetare și monitorizarea proactivă bazată pe AI, acolo unde este activată (consimțământ și/sau executarea contractului, în funcție de funcționalitate).</li>
        ...
        <ul>
          <li><strong>Interese legitime (Art. 6(1)(f)):</strong> Operarea și securizarea Serviciului, prevenirea fraudei și abuzurilor, moderarea forumului, păstrarea înregistrărilor de conformitate pentru corespondență, urmărirea firelor de corespondență și revizuirea răspunsurilor instituțiilor.</li>
        ...
        <p>Serviciul este destinat exclusiv persoanelor majore, în vârstă de cel puțin 18 ani. Nu oferim cu bună știință conturi sau servicii persoanelor sub 18 ani. Dacă considerați că am colectat date cu caracter personal de la o persoană sub 18 ani, vă rugăm să ne contactați imediat.</p>
