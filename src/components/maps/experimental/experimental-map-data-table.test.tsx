...
} from './experimental-map-data-table';
import type {
...
describe('ExperimentalMapDataTable', () => {
  const seriesColumns: ExperimentalMapTableSeriesColumn[] = [
    { id: 'series-active', label: 'Execution analytics', unit: 'RON' },
    { id: 'series-secondary', label: 'INS Population', unit: undefined },
  ];

  const rows: ExperimentalMapTableRow[] = [
    {
      sirutaCode: '12345',
      uatName: 'Demo UAT',
      countyName: 'Cluj',
