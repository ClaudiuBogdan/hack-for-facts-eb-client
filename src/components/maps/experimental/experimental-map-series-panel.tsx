...
import { ExperimentalMapSeriesList } from './experimental-map-series-list';
import { cn } from '@/lib/utils';

interface ExperimentalMapSeriesPanelProps {
...
export function ExperimentalMapSeriesPanel({
  series,
  activeSeriesId,
  collapsed,
  onToggleCollapsed,
  ...
  onDelete,
  onReorder,
}: Readonly<ExperimentalMapSeriesPanelProps>) {
  return (
