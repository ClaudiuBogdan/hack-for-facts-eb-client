...
import { ExperimentalMapBinsPresetList } from './experimental-map-bins-preset-list';

interface ExperimentalMapBinsPanelProps {
  collapsed: boolean;
...
export function ExperimentalMapBinsPanel({
  collapsed,
  presets,
  activePresetId,
  onToggleCollapsed,
  ...
  onDeletePreset,
  onReorderPresets,
}: Readonly<ExperimentalMapBinsPanelProps>) {
  return (
