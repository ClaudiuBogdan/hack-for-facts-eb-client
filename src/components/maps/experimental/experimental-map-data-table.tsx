...
import { formatExperimentalMapSeriesValue } from './experimental-map-formatting';
import type {
  ExperimentalMapBinsFilterSection,
  ExperimentalMapTableRow,
  ExperimentalMapTableSeriesColumn,
} from './experimental-map-table-types';
...
interface ExperimentalMapDataTableProps {
  rows: ExperimentalMapTableRow[];
  seriesColumns: ExperimentalMapTableSeriesColumn[];
  activeSeriesId?: string;
  onRowClick?: (row: ExperimentalMapTableRow) => void;
...
export function ExperimentalMapDataTable({
  rows,
  seriesColumns,
  activeSeriesId,
  onRowClick,
  ...
  hasActiveBinFilters,
}: Readonly<ExperimentalMapDataTableProps>) {
  ...
  const columns = useMemo<ColumnDef<ExperimentalMapTableRow>[]>(
    () => [
      {
        id: 'row_number',
      ...
      ...seriesColumns.map<ColumnDef<ExperimentalMapTableRow>>((seriesColumn) => {
        ...
        return {
          ...
          cell: ({ row }) => (
            <span>
              {formatExperimentalMapSeriesValue(
