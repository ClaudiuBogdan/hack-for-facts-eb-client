...
import { ExperimentalMapValueFilterEditorModal } from './experimental-map-value-filter-editor-modal';

describe('ExperimentalMapValueFilterEditorModal', () => {
  ...
  it('shows join selector and stats controls for non-first stats rule', () => {
    const rule = createDefaultExperimentalMapStatsValueFilterRule();
