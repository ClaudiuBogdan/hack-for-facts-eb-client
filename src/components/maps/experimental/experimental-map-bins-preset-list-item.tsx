...
interface ExperimentalMapBinsPresetListItemProps {
  preset: ExperimentalMapBinsPreset;
  isActive: boolean;
...
export const ExperimentalMapBinsPresetListItem = memo(function ExperimentalMapBinsPresetListItem({
  preset,
  isActive,
  onSetActive,
  onEdit,
  onDelete,
}: Readonly<ExperimentalMapBinsPresetListItemProps>) {
