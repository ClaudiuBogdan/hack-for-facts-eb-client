...
import { SERIES_TYPE_ICONS, SERIES_TYPE_LABELS } from './experimental-map-series-utils';

interface ExperimentalMapSeriesListItemProps {
...
export const ExperimentalMapSeriesListItem = memo(function ExperimentalMapSeriesListItem({
  series,
  isActive,
  onSetActive,
  onToggleEnabled,
  onEdit,
  onDelete,
}: Readonly<ExperimentalMapSeriesListItemProps>) {
  const {
    attributes,
    listeners,
    setNodeRef,
