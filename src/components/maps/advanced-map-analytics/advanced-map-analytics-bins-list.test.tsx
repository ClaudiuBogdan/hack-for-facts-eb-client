...
import { AdvancedMapAnalyticsBinSchema } from '@/schemas/advanced-map-analytics';
import { AdvancedMapAnalyticsBinsList } from './advanced-map-analytics-bins-list';

function makeBin(input: Parameters<typeof AdvancedMapAnalyticsBinSchema.parse>[0]) {
  return AdvancedMapAnalyticsBinSchema.parse(input);
}

describe('AdvancedMapAnalyticsBinsList', () => {
