...
function toCampaignAdminNotificationsRouteSearch(
  ...
  return {
    ...
    triggerId: search.triggerId,
    triggerMode: search.triggerMode,
    triggerDryRun: search.triggerDryRun,
    triggerLimit: search.triggerLimit,
    triggerUserId: search.triggerUserId,
    triggerRecordKey: search.triggerRecordKey,
    triggerEntityCui: search.triggerEntityCui,
    triggerInteractionId: search.triggerInteractionId,
    triggerInteractionIds: search.triggerInteractionIds,
    triggerReviewStatus: search.triggerReviewStatus,
    triggerUpdatedAtFrom: search.triggerUpdatedAtFrom,
    triggerUpdatedAtTo: search.triggerUpdatedAtTo,
    triggerSubmittedAtFrom: search.triggerSubmittedAtFrom,
    triggerSubmittedAtTo: search.triggerSubmittedAtTo,
